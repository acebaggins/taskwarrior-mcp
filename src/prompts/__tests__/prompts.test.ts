...
describe('Task Prompts', () => {
  ...
  describe('getPromptMessage', () => {
    ...
    it('should generate correct message for start-work with focus', () => {
      ...
      expect(message).toBe(
        'Start working on task "Implement new feature" and add a note that I\'m focusing on: implementing feature',
      );
    });
    ...
    it('should generate correct message for complete-with-review with accomplished', () => {
      ...
      expect(message).toBe(
        'Mark task "Implement new feature" as complete and add a note about what was accomplished: implemented new feature',
      );
    });
    ...
    it('should generate correct message for search-notes', () => {
      ...
      expect(message).toBe(
        'Find all tasks with description containing "Implement new feature" and show their notes and annotations',
      );
    });
